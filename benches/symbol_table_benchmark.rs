...
use woolink::{
    SymbolUniverse, Symbol, SymbolKind, SymbolId, PackageId,
    Visibility, DefinitionLocation,
};
...
fn bench_definition_jump(c: &mut Criterion) {
    ...
    
    {
        ...
        // Create chain
        guard.link_alias(SymbolId::new(1), SymbolId::new(2)).unwrap();
        guard.link_alias(SymbolId::new(2), SymbolId::new(3)).unwrap();
        guard.link_alias(SymbolId::new(3), SymbolId::new(4)).unwrap();
    }
