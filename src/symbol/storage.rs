...
use super::{Import, Package, Result, Symbol, SymbolError, SymbolKind, Visibility};
...
impl SoAStorage {
    ...
    pub fn get_symbol(&self, id: SymbolId) -> Option<Symbol> {
        ...
        unsafe {
            Some(Symbol {
                ...
                kind: mem::transmute::<u8, crate::symbol::SymbolKind>(
                    *self.symbol_kinds.as_ptr().add(idx),
                ),
                visibility: mem::transmute::<u8, crate::symbol::Visibility>(
                    *self.symbol_visibilities.as_ptr().add(idx),
                ),
    ...
    pub fn insert_string(&self, s: &str) -> (u32, u16) {
        ...
        let offset = self
            .string_pool_used
            .fetch_add(len as u32 + 1, Ordering::SeqCst);
    ...
    pub fn get_package(&self, id: PackageId) -> Option<Package> {
        ...
        unsafe { Some(std::ptr::read(self.packages.as_ptr().add(idx))) }
    }
