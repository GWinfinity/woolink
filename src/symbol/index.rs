...
use super::{PackageId, Result, Symbol, SymbolError, SymbolId, SymbolKind};
...
impl ChainBuilder {
    ...
    pub fn add_terminal(&mut self, symbol: SymbolId, definition: DefinitionLocation) {
        self.chains
            .insert(symbol.as_u32(), SymbolChain::new(symbol, definition));
    }
...
mod tests {
    ...
    fn test_chain_resolution() {
        ...
        index
            .insert_chain(SymbolChain::with_target(
                SymbolId::new(1),
                SymbolId::new(2),
                def_a,
            ))
        ...
        index
            .insert_chain(SymbolChain::new(SymbolId::new(3), def_c))
            .unwrap();
