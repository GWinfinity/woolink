...
use super::{DefinitionLocation, Result, SymbolError, SymbolId};
...
mod tests {
    ...
    fn test_lock_free_link() {
        let link = LockFreeLink::new(SymbolId::new(42), DefinitionLocation::new(1, 100));
    ...
    fn test_symbol_linker() {
        ...
        linker
            .link(SymbolId::new(1), SymbolId::new(2), loc)
            .unwrap();
